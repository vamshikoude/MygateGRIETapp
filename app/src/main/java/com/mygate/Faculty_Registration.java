...
public class Faculty_Registration extends AppCompatActivity {
    ...
    private static String url_Register = "https://ctcorphyd.com/MyGate/faculty_register.php";
String name1,uid1,pwd1,mno1,email1;
    ...
    class Signup extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog( Faculty_Registration.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            if(sts==2) {
                ...
                Toast.makeText(getApplicationContext(), "Faculty Id already available..!", Toast.LENGTH_SHORT).show();
            }

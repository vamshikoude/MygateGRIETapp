...
public class Faculty_RequestsList extends AppCompatActivity implements AdapterView.OnItemClickListener {
	...
	boolean sts=false;
	int st;
	private static String url_eventreq ="https://ctcorphyd.com/MyGate/fact_requests_list.php";

	private static String url_aceptrequest ="https://ctcorphyd.com/MyGate/accept_request.php";

	private static String url_rejectrequest ="https://ctcorphyd.com/MyGate/reject_request.php";
	...
	class registerreq_php extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog( Faculty_RequestsList.this);
			...
			try {
				...
				if (success == 1) {
					...
					for (int i = 0; i < json1.length(); i++) {
						...
						sv.setUserid("Faculty_id: "+c.getString( "userid" ) );
		...
		protected void onPostExecute(String file_url) {
			if(sts) {
				adapter = new RequestListAdapter( Faculty_RequestsList.this, cList );
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		userid=sv.getUserid().split( "Faculty_id: ")[1];

		AlertDialog.Builder alertDialog = new AlertDialog.Builder( Faculty_RequestsList.this);
	...
	class AcceptRequest extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String file_url) {
			...
			if(st==1) {
				...
				Toast.makeText(getApplicationContext(), "Approved,Faculty Registration Request ..!", Toast.LENGTH_SHORT).show();
				Intent i = new Intent(Faculty_RequestsList.this, HOD_Dashboard.class);
				startActivity(i);
				finish();
			}
	...
	class RejectRequest extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String file_url) {
			...
			if(st==1) {
				...
				Toast.makeText(getApplicationContext(), "Rejected,Faculty Registration Request ..!", Toast.LENGTH_SHORT).show();
				Intent i = new Intent(Faculty_RequestsList.this, HOD_Dashboard.class);
				startActivity(i);
				finish();
			}

...
public class Faculty extends AppCompatActivity {
    ...
    private static String url_login = "https://ctcorphyd.com/MyGate/faculty_login.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent( Faculty.this, Faculty_Registration.class );
    ...
    class FacultyLogin extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (success == 1) {
                  ...
                  Intent i=new Intent(Faculty.this,StatusRequestsList_Faculty.class);
        ...
        protected void onPostExecute(String file_url) {
            ...
            if(!sts){
                Toast.makeText( Faculty.this,"Invalid Credentials or HOD not yet Accepted.",Toast.LENGTH_SHORT).show();
            }
            pDialog.dismiss();
        }

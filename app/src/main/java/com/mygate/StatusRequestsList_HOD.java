...
public class StatusRequestsList_HOD extends AppCompatActivity implements AdapterView.OnItemClickListener {
	...
	boolean sts=false;
	int st;
	private static String url_stsreq ="https://ctcorphyd.com/MyGate/status_requests_list3.php";

	private static String url_aceptrequest ="https://ctcorphyd.com/MyGate/hod_accept_request.php";

	private static String url_rejectrequest ="https://ctcorphyd.com/MyGate/hod_reject_request.php";
	...
	class studentreq_php extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog( StatusRequestsList_HOD.this);
		...
		protected void onPostExecute(String file_url) {
			if(sts) {
				adapter = new StatusRequestListAdapter( StatusRequestsList_HOD.this, cList );
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		AlertDialog.Builder alertDialog = new AlertDialog.Builder( StatusRequestsList_HOD.this);
	...
	class AcceptRequest extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String file_url) {
			...
			if(st==1) {
				...
				Intent i = new Intent( StatusRequestsList_HOD.this, StatusRequestsList_HOD.class);
				startActivity(i);
				finish();
			}
	...
	class RejectRequest extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String file_url) {
			...
			if(st==1) {
				...
				Intent i = new Intent( StatusRequestsList_HOD.this, HOD_Dashboard.class);
				startActivity(i);
				finish();
			}
